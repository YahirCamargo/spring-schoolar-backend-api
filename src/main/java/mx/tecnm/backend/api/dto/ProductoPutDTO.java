...
public class ProductoPutDTO {
    ...
    public ProductoPutDTO(String nombre, BigDecimal precio, String sku, String color, String marca, String descripcion, BigDecimal peso, BigDecimal alto, BigDecimal ancho, BigDecimal profundidad){
            this.nombre = nombre;
            this.precio = precio;
            this.sku = sku;
            this.color = color;
