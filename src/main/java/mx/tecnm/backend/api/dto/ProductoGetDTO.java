...
public class ProductoGetDTO {
    ...
    public ProductoGetDTO(UUID id, String nombre, BigDecimal precio, String sku, String color, String marca, String descripcion, BigDecimal peso, BigDecimal alto, BigDecimal ancho, BigDecimal profundidad, UUID categoriasId){
            this.id = id;
            this.nombre = nombre;
            this.precio = precio;
            this.sku = sku;
